...
public class ColoSpaceConvertor extends ColorSpace {

    public static ColoSpaceConvertor getInstance() {
    ...
    private static class Holder {
        static final ColoSpaceConvertor INSTANCE = new ColoSpaceConvertor();
    }
